  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo site_url('Welcome/DataSiswa'); ?>"> <span>Siswa</span></a></li>
		<li><a href="<?php echo site_url('Welcome/DataProfile'); ?>"> <span>Profile</span></a></li>
		<li><a href="<?php echo site_url('Welcome/DataKontak'); ?>"> <span>Kontak</span></a></li>
		<li><a href="<?php echo site_url('Welcome/DataBerita'); ?>"> <span>Berita</span></a></li>
		<li><a href="<?php echo site_url('Welcome/DataGuru'); ?>"> <span>Guru</span></a></li>
		<li><a href="<?php echo site_url('Welcome/DataMatpel'); ?>"> <span>Mata Pelajaran</span></a></li>
		<li><a href="<?php echo site_url('Welcome/DataKelas'); ?>"> <span>Kelas</span></a></li>
		<li><a href="<?php echo site_url('Welcome/DataJadwal'); ?>"> <span>Jadwal</span></a></li>
